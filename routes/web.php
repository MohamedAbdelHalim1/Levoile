...
Route::middleware('auth')->group(function () {
    ...
    Route::get('design/design-materials', [DesignMaterialController::class, 'index'])->name('design-materials.index');
    Route::get('design/design-materials/{id}', [DesignMaterialController::class, 'show'])->name('design-materials.show');
    Route::get('design/design-materials/create', [DesignMaterialController::class, 'create'])->name('design-materials.create');
    Route::post('design/design-materials', [DesignMaterialController::class, 'store'])->name('design-materials.store');
    Route::get('design/design-materials/{id}/edit', [DesignMaterialController::class, 'edit'])->name('design-materials.edit');
    Route::put('design/design-materials/{id}', [DesignMaterialController::class, 'update'])->name('design-materials.update');
    Route::delete('design/design-materials/{id}', [DesignMaterialController::class, 'destroy'])->name('design-materials.destroy');
