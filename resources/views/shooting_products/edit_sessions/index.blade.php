    ...
    <table class="table table-bordered align-middle">
        ...
        <tbody>
            @foreach($sessions as $session)
                <tr>
                    <td>
                        <a href="{{ route('shooting-sessions.show', $session->reference) }}" class="btn btn-sm btn-info">
                            عرض الجلسة
                        </a>
                    </td>
                    <td>
    ...
    <div class="modal-dialog">
        <form method="POST" action="{{ route('edit-sessions.upload-drive-link') }}" class="modal-content">
            ...
            <div class="modal-body">
                <input type="url" name="drive_link" class="form-control" placeholder="ضع رابط Google Drive" required>
            </div>
