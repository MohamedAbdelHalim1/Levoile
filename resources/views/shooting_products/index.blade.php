                    ...
                    <form id="shootingForm">
                        ...
                        <div class="step step-1">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label ms-3" for="productShooting">تصوير منتج</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input shooting-type" type="radio" name="type_of_shooting"
                                    value="تصوير موديل" id="modelShooting">
                                <label class="form-check-label ms-3" for="modelShooting">تصوير موديل</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input shooting-type" type="radio" name="type_of_shooting"
                                    value="تعديل لون" id="colorEditing">
                                <label class="form-check-label ms-3" for="colorEditing">تعديل لون</label>
                            </div>
                        </div>
                        ...
                        <div class="step step-2 d-none">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label ms-3" for="indoor">تصوير بالداخل</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input shooting-location" type="radio" name="location"
                                    value="تصوير بالخارج" id="outdoor">
                                <label class="form-check-label ms-3" for="outdoor">تصوير بالخارج</label>
                            </div>
                        </div>
