            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="min-width:130px">
                  <select class="form-control" name="colors[{{ $index }}][unit]">
                    <option value="" @selected(old('colors.'.$index.'.unit')=='')>-</option>
                    <option value="kg" @selected(old('colors.'.$index.'.unit')=='kg')>{{ __('messages.kg') }}</option>
                    <option value="meter" @selected(old('colors.'.$index.'.unit')=='meter')>{{ __('messages.meter') }}</option>
                  </select>
                </td>
