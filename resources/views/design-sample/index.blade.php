                        ...
                        <tbody>
                            @foreach ($samples as $key => $sample)
                                <tr>
                                    ...
                                    <td>
                                        @if ($sample->sample_sizes_file)
                                            <a href="{{ asset($sample->sample_sizes_file) }}" target="_blank"
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="addSampleSizesModal{{ $sample->id }}"
                                            tabindex="-1" aria-labelledby="addSampleSizesLabel{{ $sample->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form
                                                    action="{{ route('design-sample-products.add-sample-sizes', $sample->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="addSampleSizesLabel{{ $sample->id }}">
                                                                مقاسات العينة
                                                            </h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label>ارفع ملف المقاسات (PDF أو صورة)</label>
                                                                <input type="file" name="sample_sizes_file"
                                                                    class="form-control" accept=".pdf,image/*" required>
                                                            </div>

                                                            @if ($sample->sample_sizes_file)
                                                                <div class="mt-2">
                                                                    <small class="text-muted d-block mb-1">الملف
                                                                        الحالي:</small>
                                                                    <a href="{{ asset($sample->sample_sizes_file) }}"
                                                                        target="_blank"
                                                                        class="btn btn-sm btn-light border">
                                                                        فتح / تحميل
                                                                    </a>
