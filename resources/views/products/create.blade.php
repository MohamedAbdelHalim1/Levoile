            ...
            <div class="p-8 bg-white shadow sm:rounded-lg border border-gray-200">
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control selectpicker" id="season_id" name="season_id" data-live-search="true"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control selectpicker" id="factory_id" name="factory_id" data-live-search="true"
                            required>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <input type="text" class="form-control" id="material_name" name="material_name"
                                    placeholder="{{ __('اسم المواد ') }}" required>
                            </div>
                        </div>
                    </div>
